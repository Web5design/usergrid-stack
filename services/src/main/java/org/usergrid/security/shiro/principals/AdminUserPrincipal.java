...
public class AdminUserPrincipal extends UserPrincipal
{
    ...
    public void populateAuthorizatioInfo( UsergridAuthorizationInfo info, UsergridRealm realm ) throws Exception
    {
        ...
        if ( superUserEnabled && ( superUser != null ) && superUser.equals( user.getUsername() ) )
        {
            ...
            info.addStringPermission( "organizations:admin,access,get,put,post,delete:*" );
            info.addStringPermission( "applications:admin,access,get,put,post,delete:*" );
            info.addStringPermission( "organizations:admin,access,get,put,post,delete:*:/**" );
            info.addStringPermission( "applications:admin,access,get,put,post,delete:*:/**" );
            info.addStringPermission( "users:access:*" );

            info.addStringPermission( getPermissionFromPath( MANAGEMENT_APPLICATION_ID, "access" ) );
        ...
        else
        {
            ...
            if ( userOrganizations != null )
            {
                ...
                {
                    info.addStringPermission( new StringBuilder( "organizations:admin,access,get,put,post,delete:" )
