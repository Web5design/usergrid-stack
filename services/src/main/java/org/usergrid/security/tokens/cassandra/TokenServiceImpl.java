...
import static org.usergrid.persistence.CassandraPersistenceUtils.getColumnMap;
...
public class TokenServiceImpl implements TokenService {
  ...
  private long getMaxTtl(TokenCategory tokenCategory, AuthPrincipalInfo principal) throws Exception {
    ...
    Application application = emf.getEntityManager(principal.getApplicationId()).get(principal.getApplicationId(),
        Application.class);
   ...
   * 
   * @see
   * org.usergrid.security.tokens.TokenService#getMaxTokenAgeInSeconds(java.
   * lang.String)
   */
  @Override
