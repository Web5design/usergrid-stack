...
public class StartSearch extends NoTransactionSearch {
   ...
   * (non-Javadoc)
   * 
   * @see org.usergrid.persistence.mq.io.NoTransaction#getParams(java.util.UUID,
   * java.util.UUID, org.usergrid.persistence.mq.QueueQuery)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.usergrid.persistence.mq.io.FifoSearch#writeClientPointer(java.util.UUID, java.util.UUID, java.util.UUID)
   */
  @Override
