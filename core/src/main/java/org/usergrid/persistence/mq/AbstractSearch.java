...
import static org.usergrid.persistence.mq.CassandraMQUtils.deserializeMessage;
import static org.usergrid.persistence.mq.CassandraMQUtils.getQueueShardRowKey;
import static org.usergrid.persistence.mq.QueueManagerImpl.ALL_COUNT;
import static org.usergrid.persistence.mq.QueueManagerImpl.QUEUE_SHARD_INTERVAL;
import static org.usergrid.persistence.mq.QueueManagerImpl.se;
import static org.usergrid.persistence.mq.QueuesCF.CONSUMERS;
import static org.usergrid.persistence.mq.QueuesCF.MESSAGE_PROPERTIES;
import static org.usergrid.persistence.mq.QueuesCF.QUEUE_INBOX;
import static org.usergrid.persistence.mq.QueuesCF.QUEUE_PROPERTIES;
...
public abstract class AbstractSearch implements QueueSearch {
   ...
   * @return
   */
  protected List<UUID> getQueueRange(UUID queueId, QueueBounds bounds, NoTransactionSearch.SearchParam params) {
