...
import static org.usergrid.persistence.mq.CassandraMQUtils.getConsumerId;
import static org.usergrid.persistence.mq.QueueManagerImpl.DEFAULT_SEARCH_COUNT;
import static org.usergrid.persistence.mq.QueueManagerImpl.QUEUE_SHARD_INTERVAL;
import static org.usergrid.persistence.mq.QueuesCF.PROPERTY_INDEX;
...
public class FilterSearch extends NoTransactionSearch {
   ...
   * (non-Javadoc)
   * 
   * @see org.usergrid.persistence.mq.QueueSearch#getResults(java.lang.String,
   * org.usergrid.persistence.mq.QueueQuery)
   */
  @Override
