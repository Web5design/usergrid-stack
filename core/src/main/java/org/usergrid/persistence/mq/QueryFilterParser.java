...
import org.usergrid.persistence.mq.Query.FilterPredicate;
import org.usergrid.persistence.mq.Query.SortPredicate;

public class QueryFilterParser extends Parser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "ID", "INT", "EXPONENT", "FLOAT", "ESC_SEQ", "STRING", "BOOLEAN", "HEX_DIGIT", "UUID", "UNICODE_ESC", "OCTAL_ESC", "WS", "'<'", "'<='", "'='", "'>'", "'>='", "'in'", "'eq'", "'lt'", "'gt'", "'lte'", "'gte'", "'contains'", "'within'", "','", "'of'", "':'", "'asc'", "'desc'", "'*'", "'{'", "'}'", "'select'", "'where'", "'and'", "'order by'"
    };
    ...
    // org/usergrid/persistence/query/QueryFilter.g:104:1: operator : ( '<' | '<=' | '=' | '>' | '>=' | 'in' | 'eq' | 'lt' | 'gt' | 'lte' | 'gte' | 'contains' | 'within' ) ;
    public final QueryFilterParser.operator_return operator() throws RecognitionException {
        ...
        try {
            // org/usergrid/persistence/query/QueryFilter.g:105:2: ( ( '<' | '<=' | '=' | '>' | '>=' | 'in' | 'eq' | 'lt' | 'gt' | 'lte' | 'gte' | 'contains' | 'within' ) )
            // org/usergrid/persistence/query/QueryFilter.g:105:4: ( '<' | '<=' | '=' | '>' | '>=' | 'in' | 'eq' | 'lt' | 'gt' | 'lte' | 'gte' | 'contains' | 'within' )
            {
    ...
    // $ANTLR start "filter"
    // org/usergrid/persistence/query/QueryFilter.g:113:1: filter returns [FilterPredicate filter] : property operator value ( ( ',' | 'of' ) second_value ( ',' third_value )? )? EOF ;
    public final FilterPredicate filter() throws RecognitionException {
        ...
        try {
            ...
            // org/usergrid/persistence/query/QueryFilter.g:114:33: ( ( ',' | 'of' ) second_value ( ',' third_value )? )?
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // org/usergrid/persistence/query/QueryFilter.g:114:34: ( ',' | 'of' ) second_value ( ',' third_value )?
                    {
    ...
    // org/usergrid/persistence/query/QueryFilter.g:140:1: select_assign : select_assign_target ':' select_assign_source ;
    ...
    // $ANTLR start "where"
    // org/usergrid/persistence/query/QueryFilter.g:148:1: where : ( property operator value ( ( ',' | 'of' ) second_value ( ',' third_value )? )? ) ;
    public final void where() throws RecognitionException {
        ...
        try {
            // org/usergrid/persistence/query/QueryFilter.g:149:2: ( ( property operator value ( ( ',' | 'of' ) second_value ( ',' third_value )? )? ) )
            ...
            // org/usergrid/persistence/query/QueryFilter.g:149:29: ( ( ',' | 'of' ) second_value ( ',' third_value )? )?
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // org/usergrid/persistence/query/QueryFilter.g:149:30: ( ',' | 'of' ) second_value ( ',' third_value )?
                    {
                    if ( (input.LA(1)>=29 && input.LA(1)<=30) ) {
                        input.consume();
                        state.errorRecovery=false;
    ...
    // org/usergrid/persistence/query/QueryFilter.g:178:1: select_expr : ( '*' | select_subject ( ',' select_subject )* | '{' select_assign ( ',' select_assign )* '}' ) ;
    public final void select_expr() throws RecognitionException {
        try {
            // org/usergrid/persistence/query/QueryFilter.g:179:2: ( ( '*' | select_subject ( ',' select_subject )* | '{' select_assign ( ',' select_assign )* '}' ) )
            // org/usergrid/persistence/query/QueryFilter.g:179:4: ( '*' | select_subject ( ',' select_subject )* | '{' select_assign ( ',' select_assign )* '}' )
            {
            // org/usergrid/persistence/query/QueryFilter.g:179:4: ( '*' | select_subject ( ',' select_subject )* | '{' select_assign ( ',' select_assign )* '}' )
            int alt8=3;
            switch ( input.LA(1) ) {
    ...
    // $ANTLR start "ql"
    // org/usergrid/persistence/query/QueryFilter.g:181:1: ql returns [Query q] : 'select' select_expr ( 'where' where ( 'and' where )* )? ( 'order by' order ( ',' order )* )? ;
