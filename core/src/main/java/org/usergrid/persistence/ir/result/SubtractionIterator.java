...
public class SubtractionIterator extends MergeIterator {
   ...
   * (non-Javadoc)
   * 
   * @see org.usergrid.persistence.ir.result.ResultIterator#reset()
   */
  @Override
  public void doReset() {
    keepIterator.reset();
   ...
   * (non-Javadoc)
   * 
   * @see org.usergrid.persistence.ir.result.MergeIterator#advance()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.usergrid.persistence.ir.result.ResultIterator#finalizeCursor(org.usergrid.persistence.CursorCache)
   */
  @Override
